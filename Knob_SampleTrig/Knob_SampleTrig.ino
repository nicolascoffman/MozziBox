...
#include <samples/mine/Blip2.h> // a converted audio sample included in the Mozzi download
...
Sample <Blip2_NUM_CELLS, AUDIO_RATE> aSample(Blip2_DATA);
float recorded_pitch = (float) Blip2_SAMPLERATE / (float) Blip2_NUM_CELLS;
